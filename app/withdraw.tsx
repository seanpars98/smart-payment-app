...
export default function WithdrawScreen() {
  ...
  const handleWithdraw = async () => {
    ...
    if (amountValue > availableBalance) {
      Alert.alert("Insufficient Funds", `Your ${selectedCurrency} balance is not enough for this withdrawal`);
      return;
    }
    ...
    try {
      addTransaction({
        ...
        sender: { id: "user-1", name: "John Doe", username: "johndoe", email: "john@example.com" },
        recipient: { id: "bank", name: "Bank Account", username: "", email: "" },
        status: "completed",
      });
      
      Alert.alert(
        "Withdrawal Initiated",
        `You've successfully withdrawn $${amountValue.toFixed(2)} ${selectedCurrency} to your bank account`,
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.formContainer}>
          <View style={styles.bankSection}>
            <Text style={styles.sectionTitle}>To Bank Account</Text>
          ...
          <Text style={styles.disclaimer}>
            By proceeding, you agree to our Terms of Service. Withdrawals may take
            1-3 business days to appear in your bank account depending on your
